...
import hamburgerImg from "../../assets/img/hamburger.webp";
  ...
  return (
    <div className={styles.authContainer}>
      <div className={`${styles.authLeft} col`}>
        <picture>
          <source srcSet="/img/hamburger.avif" type="image/avif" />
          <source srcSet="/img/hamburger.webp" type="image/webp" />
          <img src={hamburgerImg} alt="hamburger" fetchPriority="high" />
        </picture>
