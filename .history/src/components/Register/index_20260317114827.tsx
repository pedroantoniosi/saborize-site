  ...
  return (
    <div className={`authContainer`}>
      <div className={`authContent`}>
        ...
        <form
          className={`formContainer col gap-1`}
          onSubmit={handleSubmit(onSubmit)}
        >
          <div className="col">
            <label className="mb-05">Email:</label>
            <input
              type="text"
          ...
          <div className="col">
            <label className="mb-05">Nome do Usuário:</label>
            <input
              type="text"
              className={`inputRegister`}
          ...
          <div className="col">
            <label className="mb-05">Senha:</label>
            <input
              type="password"
              className={`inputRegister`}
          ...
          <div className="col">
            <label className="mb-05">Confirme a senha:</label>
            <input
              type="password"
              className={`inputRegister`}
          ...
          <div className={`row gap-1`}>
            <div>
              <label className="mb-05">Dia</label>
              <input
                type="text"
                className={`inputRegister`}
                {...register("formDay", {
            ...
            <div>
              <label className="mb-05">Mês</label>
              <input
                type="text"
                className={`inputRegister`}
                {...register("formMonth", {
            ...
            <div>
              <label className="mb-05">Ano</label>
              <input
                type="text"
                className={`inputRegister`}
                {...register("formYear", {
          ...
          <div className="col  gap-05 py-1">
            ...
            <p className="terms-text">
              Ao tocar em <strong className={``}>Cadastrar</strong>, você
              concorda em criar uma conta e em{" "}
              <strong className={``}>Termos</strong>,{" "}
              <strong className={``}>Políticas de Privacidade</strong> e{" "}
              <strong className={``}>Política de Cookies</strong>.
            </p>
            <p className="terms-text">
              A <strong className={``}>Políticas de Privacidade</strong>{" "}
