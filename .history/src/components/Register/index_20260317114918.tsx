      ...
      <div className={`authContent`}>
        ...
        >
          ...
          <div className="col  gap-05 py-1">
            ...
            <p className="terms-text">
              Ao tocar em <strong className={`colorPrimary`}>Cadastrar</strong>,
              você concorda em criar uma conta e em{" "}
              <strong className={`colorPrimary`}>Termos</strong>,{" "}
              <strong className={`colorPrimary`}>
                Políticas de Privacidade
              </strong>{" "}
              e <strong className={`colorPrimary`}>Política de Cookies</strong>.
            </p>
            <p className="terms-text">
