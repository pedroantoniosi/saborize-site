        ...
        */}
        <form className={styles.registerForm} onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="col  gap-05 py-1">
            ...
            <p className="terms-text">
              Ao tocar em <strong className="terms">Cadastrar</strong>, você
              concorda em criar uma conta e em{" "}
              <strong className="terms">Termos</strong>,{" "}
              <strong className="terms">Políticas de Privacidade</strong> e{" "}
              <strong className="terms">Política de Cookies</strong>.
            </p>
            <p className="terms-text">
              A <strong className="terms">Políticas de Privacidade</strong>{" "}
